...
<body>
    ...
    <div class="container p-4">
        <div class="d-flex justify-content-between mb-4">
            <a href="home.php"><button class="btn btn-primary"><i class="bi bi-caret-left"></i> Back</button></a>
        </div>
        ...
        <table id="myTable" class="table table-hover table-striped">
            ...
            <tbody class="table-light">
                <?php $dataTable->dataTable("Archived"); ?>
            </tbody>
    ...
    <!--############################## MODALS ##############################-->
    <?php $dataTable->retrieveModalStudents(); ?>
